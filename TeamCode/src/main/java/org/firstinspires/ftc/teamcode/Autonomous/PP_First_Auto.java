...
public class PP_First_Auto extends LinearOpMode {
    ...
    private final Pose scorePose   = new Pose(80,   80,  Math.toRadians(60));
    private final Pose pickup1Pose = new Pose(12,  56,  Math.toRadians(-180));
    private final Pose parkPose    = new Pose(80,   80,  Math.toRadians(60));
